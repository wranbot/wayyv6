...
const { ngazap } = require('./all/bugCybot/ngazap')
const { buttonkal } = require('./all/bugCybot/buttonkal')
const { cttl } = require('./all/bugCybot/cttl')
const { tizi } = require('./all/bugCybot/tizi')
const { weg } = require('./all/bugCybot/weg')
const { virtex7 } = require('./all/bugCybot/virtex7')
...
case 'sendgasfull' :  case '🐵':{
 if (!isOwner) return m.reply('*khusus Bang Cybot*')
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
await sleep(2000)
haikal.sendMessage(Pe, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
await sleep(2000)
haikal.sendMessage(Pe, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
...
haikal.sendMessage(Pe, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
await sleep(2000)
haikal.sendMessage(Pe, { image: ppuser,  caption: `${buttonkal}` }, { quoted:Cybot })
await sleep(2000)
}
...
case 'sendunlidelay' :  case '🐒':{
 ...
 await reply(mess.wait)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, {text: virtex7}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: virtex7}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: virtex7}, {quoted:Cybot})
...
case 'sendunlilag' : case'🙊': {
 ...
 await reply(mess.wait)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, {text: cttl}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: cttl}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: cttl}, {quoted:Cybot})
...
case 'sendunlibom' :  case '🙉':{
 ...
 await reply(mess.wait)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, {text: weg}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: weg}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: weg}, {quoted:Cybot})
...
case 'sendunlicuy' :  case '🙈':{
 ...
 await reply(mess.wait)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, {text: tizi}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: tizi}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: tizi}, {quoted:Cybot})
...
//=================================================//
 ...
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
haikal.sendMessage(from, {text: `${botname}`}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: `${botname}`}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: `${botname}`}, {quoted:Cybot})
...
case 'unlidelay' :  {
 ...
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
haikal.sendMessage(from, {text: virtex7}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: virtex7}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: virtex7}, {quoted:Cybot})
...
case 'unlilag' :  {
 ...
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
haikal.sendMessage(from, {text: cttl}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: cttl}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: cttl}, {quoted:Cybot})
...
case 'unlibom' :  {
 ...
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
haikal.sendMessage(from, {text: weg}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: weg}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: weg}, {quoted:Cybot})
...
case 'unlicuy' :  {
 ...
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
haikal.sendMessage(from, {text: tizi}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: tizi}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(from, {text: tizi}, {quoted:Cybot})
...
case 'unlivirtext' :  {
 ...
 if (!text) return reply(`penggunaan salah Cybot harusnya ${prefix+command} 628xxx `)
 await reply(mess.wait)
haikal.sendMessage(from, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
await sleep(2000)
haikal.sendMessage(from, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
await sleep(2000)
haikal.sendMessage(from, { image: bugCybot,  caption: `${buttonkal}` }, { quoted:Cybot })
...
case 'santet' : case '🌷' : case '🐲': case '🐉': case '🌵': case '🎄': case '🌲': case '🌳': case '🌱': case '🌿': case '🍀': case '☘️': {
 ...
 await reply(mess.wait)
Pe = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(Pe, {text: `${botname}`}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: `${botname}`}, {quoted:Cybot})
await sleep(2000)
haikal.sendMessage(Pe, {text: `${botname}`}, {quoted:Cybot})
...
reply("sukses bang Cybot jangan lupa di tunggu 1 menit")
break
default:
if (budy.startsWith('=>')) {
